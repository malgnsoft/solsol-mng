...
export const wbsGantt: GanttItem[] = [
  ...
  { step: 6, group: "공통·기반", name: "프레임워크·스키마·공통모듈", owner: "조백개", responsible: "김도형", start: "2026-06-26", end: "2026-08-01", progress: 35 },
  { step: 6, group: "공통·기반", name: "외부 API 연동 (소셜·메시징·결제·본인인증·위캔디오)", owner: "조백개", responsible: "김도형", start: "2026-06-26", end: "2026-08-29", progress: 5 },
  { step: 6, group: "공통·기반", name: "인프라·CI/CD", owner: "신배담", responsible: "김도형", start: "2026-06-26", end: "2026-08-15", progress: 0 },
  { step: 6, group: "공통·기반", name: "API 개발", owner: "조백개", responsible: "김도형", start: "2026-06-26", end: "2026-08-22", progress: 10 },
  ...
  { step: 6, group: "사용자단 구현(FR01)", name: "CF 인증·가입", owner: "강프개", responsible: "김도형", start: "2026-06-26", end: "2026-07-25", progress: 35 },
  ...
  { step: 7, group: "플랫폼 기획", name: "브랜드사이트 서브페이지 기획", owner: "방준영", responsible: "방준영", start: "2026-04-21", end: "2026-06-30", progress: 60 },
  { step: 7, group: "플랫폼 기획", name: "사이트 템플릿 작업 (12종)", owner: "방준영", responsible: "방준영", start: "2026-05-01", end: "2026-07-15", progress: 30 },
  { step: 7, group: "플랫폼 기획", name: "SEO 설정 및 셋팅", owner: "방준영", responsible: "방준영", start: "2026-06-01", end: "2026-07-15", progress: 20 },
  { step: 7, group: "테스트", name: "기획·디자인·퍼블리싱 산출물 체크", owner: "오품관", responsible: "방준영", start: "2026-07-01", end: "2026-08-15", progress: 0 },
  { step: 7, group: "테스트", name: "전체 QA", owner: "오품관", responsible: "방준영", start: "2026-08-01", end: "2026-08-31", progress: 0 },
  { step: 7, group: "운영 및 정책", name: "운영가이드 작업", owner: "방준영", responsible: "방준영", start: "2026-05-11", end: "2026-07-31", progress: 30, note: "Google Sheets 관리" },
  { step: 7, group: "운영 및 정책", name: "이용약관 셋팅", owner: "방준영", responsible: "방준영", start: "2026-07-01", end: "2026-07-31", progress: 0 },
  { step: 7, group: "운영 및 정책", name: "개인정보처리 방침", owner: "방준영", responsible: "방준영", start: "2026-07-01", end: "2026-07-31", progress: 0 },
  { step: 7, group: "운영 및 정책", name: "마케팅동의 약관", owner: "방준영", responsible: "방준영", start: "2026-07-01", end: "2026-07-31", progress: 0 },
  { step: 7, group: "운영 및 정책", name: "FAQ 작성", owner: "방준영", responsible: "방준영", start: "2026-07-15", end: "2026-08-15", progress: 0 },
  { step: 7, group: "마케팅", name: "알림 마케팅 기획", owner: "방준영", responsible: "방준영", start: "2026-06-01", end: "2026-07-15", progress: 40 },
  { step: 7, group: "마케팅", name: "크리에이터 섭외 (베타오픈 10명 확보 및 협의)", owner: "미정", responsible: "미정", start: "2026-07-01", end: "2026-08-15", progress: 0 },
  { step: 7, group: "마케팅", name: "오픈 프로모션 기획", owner: "미정", responsible: "미정", start: "2026-08-01", end: "2026-08-31", progress: 0 },
  { step: 7, group: "계약", name: "토스페이먼츠 PG 계약", owner: "미정", responsible: "미정", start: "2026-06-01", end: "2026-07-15", progress: 10 },
  { step: 7, group: "계약", name: "NHN Cloud 신청", owner: "미정", responsible: "미정", start: "2026-06-01", end: "2026-06-30", progress: 60 },
  { step: 7, group: "계약", name: "신한은행 펌뱅킹 계약", owner: "미정", responsible: "미정", start: "2026-07-01", end: "2026-08-15", progress: 0 },
  { step: 7, group: "계약", name: "나이스평가정보 심사 및 계약", owner: "미정", responsible: "미정", start: "2026-06-01", end: "2026-08-15", progress: 10 },
  { step: 7, group: "WBS", name: "D-F 관리", owner: "방준영", responsible: "방준영", start: "2026-04-26", end: "2026-08-31", progress: 50, note: "Google Sheets 관리" },
]
