...
// (단계별 상대 중요도: 구현 40 > 운영 12 > 화면설계·설계 … > 스파이크 7)
...
export const wbsGantt: GanttItem[] = [
  ...
  { step: 7, group: "공통·기반", name: "프레임워크·스키마·공통모듈", owner: "조백개", responsible: "김도형", start: "2026-07-06", end: "2026-08-11", progress: 35 },
  { step: 7, group: "공통·기반", name: "외부 API 연동 (소셜·메시징·결제·본인인증·위캔디오)", owner: "조백개", responsible: "김도형", start: "2026-07-06", end: "2026-09-08", progress: 5 },
  { step: 7, group: "공통·기반", name: "인프라·CI/CD", owner: "신배담", responsible: "김도형", start: "2026-07-06", end: "2026-08-25", progress: 0 },
  { step: 7, group: "공통·기반", name: "API 개발", owner: "조백개", responsible: "김도형", start: "2026-07-06", end: "2026-09-01", progress: 10 },
  { step: 7, group: "공통·기반", name: "배치 프로세스", owner: "조백개", responsible: "김도형", start: "2026-08-03", end: "2026-08-29", progress: 0 },
  { step: 7, group: "관리자단 구현(AD01)", name: "AD 인증·사용자", owner: "임관개", responsible: "김도형", start: "2026-07-06", end: "2026-07-21", progress: 0 },
  { step: 7, group: "관리자단 구현(AD01)", name: "AD 상품 (강의·디지털·패키지·커뮤니티·멤버십)", owner: "임관개", responsible: "김도형", start: "2026-07-06", end: "2026-08-18", progress: 0 },
  { step: 7, group: "관리자단 구현(AD01)", name: "AD 콘텐츠", owner: "임관개", responsible: "김도형", start: "2026-07-06", end: "2026-08-04", progress: 0 },
  { step: 7, group: "관리자단 구현(AD01)", name: "AD 판매 (주문·쿠폰·환불)", owner: "임관개", responsible: "김도형", start: "2026-07-06", end: "2026-08-18", progress: 0 },
  { step: 7, group: "관리자단 구현(AD01)", name: "AD 운영·설정", owner: "임관개", responsible: "김도형", start: "2026-07-06", end: "2026-08-11", progress: 0 },
  { step: 7, group: "관리자단 구현(AD01)", name: "AD 마케팅·사이트디자인", owner: "임관개", responsible: "김도형", start: "2026-07-06", end: "2026-09-03", progress: 0 },
  { step: 7, group: "관리자단 구현(AD01)", name: "AD 정산·통계", owner: "임관개", responsible: "김도형", start: "2026-07-15", end: "2026-09-12", progress: 0 },
  { step: 7, group: "사용자단 구현(FR01)", name: "CF 인증·가입", owner: "강프개", responsible: "김도형", start: "2026-07-06", end: "2026-08-04", progress: 35 },
  { step: 7, group: "사용자단 구현(FR01)", name: "CF 강의·상품 (6유형)", owner: "배현우", responsible: "김도형", start: "2026-07-06", end: "2026-08-25", progress: 0 },
  { step: 7, group: "사용자단 구현(FR01)", name: "CF 결제·마이페이지", owner: "강프개", responsible: "김도형", start: "2026-07-15", end: "2026-09-05", progress: 0 },
  { step: 7, group: "사용자단 구현(FR01)", name: "CF 커뮤니티·멤버십·게시판", owner: "강프개", responsible: "김도형", start: "2026-07-15", end: "2026-09-12", progress: 0 },
  { step: 7, group: "브랜드 구현(BR01)", name: "Brand 인증·플랜구독", owner: "강프개", responsible: "김도형", start: "2026-07-15", end: "2026-09-05", progress: 0 },
  { step: 7, group: "브랜드 구현(BR01)", name: "Brand 마이페이지·소개·기타", owner: "강프개", responsible: "김도형", start: "2026-08-03", end: "2026-09-19", progress: 0 },
  { step: 7, group: "브랜드 관리자단(BO)", name: "BackOffice 구현", owner: "임관개", responsible: "김도형", start: "2026-07-06", end: "2026-09-01", progress: 0 },
  { step: 8, group: "플랫폼 기획", name: "브랜드사이트 서브페이지 기획", owner: "방준영", responsible: "방준영", start: "2026-04-21", end: "2026-06-30", progress: 60 },
  { step: 8, group: "플랫폼 기획", name: "사이트 템플릿 작업 (12종)", owner: "방준영", responsible: "방준영", start: "2026-05-01", end: "2026-07-15", progress: 30 },
  { step: 8, group: "플랫폼 기획", name: "SEO 설정 및 셋팅", owner: "방준영", responsible: "방준영", start: "2026-06-01", end: "2026-07-15", progress: 20 },
  { step: 8, group: "테스트", name: "기획·디자인·퍼블리싱 산출물 체크", owner: "오품관", responsible: "방준영", start: "2026-07-01", end: "2026-08-15", progress: 0 },
  { step: 8, group: "테스트", name: "전체 QA", owner: "오품관", responsible: "방준영", start: "2026-08-01", end: "2026-08-31", progress: 0 },
  { step: 8, group: "운영 및 정책", name: "운영가이드 작업", owner: "방준영", responsible: "방준영", start: "2026-05-11", end: "2026-07-31", progress: 30, note: "Google Sheets 관리" },
  { step: 8, group: "운영 및 정책", name: "이용약관 셋팅", owner: "방준영", responsible: "방준영", start: "2026-07-01", end: "2026-07-31", progress: 0 },
  { step: 8, group: "운영 및 정책", name: "개인정보처리 방침", owner: "방준영", responsible: "방준영", start: "2026-07-01", end: "2026-07-31", progress: 0 },
  { step: 8, group: "운영 및 정책", name: "마케팅동의 약관", owner: "방준영", responsible: "방준영", start: "2026-07-01", end: "2026-07-31", progress: 0 },
  { step: 8, group: "운영 및 정책", name: "FAQ 작성", owner: "방준영", responsible: "방준영", start: "2026-07-15", end: "2026-08-15", progress: 0 },
  { step: 8, group: "마케팅", name: "알림 마케팅 기획", owner: "방준영", responsible: "방준영", start: "2026-06-01", end: "2026-07-15", progress: 40 },
  { step: 8, group: "마케팅", name: "크리에이터 섭외 (베타오픈 10명 확보 및 협의)", owner: "미정", responsible: "미정", start: "2026-07-01", end: "2026-08-15", progress: 0 },
  { step: 8, group: "마케팅", name: "오픈 프로모션 기획", owner: "미정", responsible: "미정", start: "2026-08-01", end: "2026-08-31", progress: 0 },
  { step: 8, group: "계약", name: "토스페이먼츠 PG 계약", owner: "미정", responsible: "미정", start: "2026-06-01", end: "2026-07-15", progress: 10 },
  { step: 8, group: "계약", name: "NHN Cloud 신청", owner: "미정", responsible: "미정", start: "2026-06-01", end: "2026-06-30", progress: 60 },
  { step: 8, group: "계약", name: "신한은행 펌뱅킹 계약", owner: "미정", responsible: "미정", start: "2026-07-01", end: "2026-08-15", progress: 0 },
  { step: 8, group: "계약", name: "나이스평가정보 심사 및 계약", owner: "미정", responsible: "미정", start: "2026-06-01", end: "2026-08-15", progress: 10 },
  { step: 8, group: "WBS", name: "D-F 관리", owner: "방준영", responsible: "방준영", start: "2026-04-26", end: "2026-08-31", progress: 50, note: "Google Sheets 관리" },
]
