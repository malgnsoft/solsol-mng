...
export const wbsGantt: GanttItem[] = [
  ...
  { step: 7, group: "공통·기반", name: "API 개발", owner: "조백개", responsible: "김도형", start: "2026-06-26", end: "2026-08-22", progress: 10 },
  { step: 7, group: "공통·기반", name: "배치 프로세스", owner: "조백개", responsible: "김도형", start: "2026-08-03", end: "2026-08-29", progress: 0 },
  { step: 7, group: "관리자단 구현(AD01)", name: "AD 인증·사용자", owner: "임관개", responsible: "김도형", start: "2026-06-26", end: "2026-07-11", progress: 0 },
  { step: 7, group: "관리자단 구현(AD01)", name: "AD 상품 (강의·디지털·패키지·커뮤니티·멤버십)", owner: "임관개", responsible: "김도형", start: "2026-06-26", end: "2026-08-08", progress: 0 },
  { step: 7, group: "관리자단 구현(AD01)", name: "AD 콘텐츠", owner: "임관개", responsible: "김도형", start: "2026-06-26", end: "2026-07-25", progress: 0 },
  { step: 7, group: "관리자단 구현(AD01)", name: "AD 판매 (주문·쿠폰·환불)", owner: "임관개", responsible: "김도형", start: "2026-06-26", end: "2026-08-08", progress: 0 },
  { step: 7, group: "관리자단 구현(AD01)", name: "AD 운영·설정", owner: "임관개", responsible: "김도형", start: "2026-06-26", end: "2026-08-01", progress: 0 },
  { step: 7, group: "관리자단 구현(AD01)", name: "AD 마케팅·사이트디자인", owner: "임관개", responsible: "김도형", start: "2026-07-01", end: "2026-08-29", progress: 0 },
  { step: 7, group: "관리자단 구현(AD01)", name: "AD 정산·통계", owner: "임관개", responsible: "김도형", start: "2026-07-15", end: "2026-09-12", progress: 0 },
  { step: 7, group: "사용자단 구현(FR01)", name: "CF 인증·가입", owner: "강프개", responsible: "김도형", start: "2026-06-26", end: "2026-07-25", progress: 35 },
  { step: 7, group: "사용자단 구현(FR01)", name: "CF 강의·상품 (6유형)", owner: "배현우", responsible: "김도형", start: "2026-06-26", end: "2026-08-15", progress: 0 },
  ...
  { step: 7, group: "브랜드 관리자단(BO)", name: "BackOffice 구현", owner: "임관개", responsible: "김도형", start: "2026-06-26", end: "2026-08-22", progress: 0 },
