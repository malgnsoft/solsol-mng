...
INSERT INTO wbs_item (id,step,grp,name,owner,start,end,progress,note,href,sort) VALUES (5,1,'공통','외부 API 분석 및 어댑터 설계','조수현, 서만원','2026-04-27','2026-05-10',90,'소셜로그인 · 메시징 · 결제 · 본인인증 · 위캔디오',NULL,4);
INSERT INTO wbs_item (id,step,grp,name,owner,start,end,progress,note,href,sort) VALUES (6,1,'공통','외부 API 연동','조수현, 서만원','2026-04-27','2026-05-10',65,'소셜·메시징 적용 · 결제PG·NICE·위캔디오 대기',NULL,5);
INSERT INTO wbs_item (id,step,grp,name,owner,start,end,progress,note,href,sort) VALUES (7,1,'백엔드','API 개발','서만원','2026-04-27','2026-05-10',80,NULL,NULL,6);
...
INSERT INTO wbs_item (id,step,grp,name,owner,start,end,progress,note,href,sort) VALUES (9,2,'Customer Admin','CA - 인증 + 사용자 관리','조수현','2026-04-27','2026-05-24',95,'[상] 사용자 95% 완료 · 목록·상세·탭·모달 배선',NULL,8);
INSERT INTO wbs_item (id,step,grp,name,owner,start,end,progress,note,href,sort) VALUES (10,2,'Customer Admin','CA - 콘텐츠 관리','서만원','2026-04-27','2026-05-10',85,'[상] assets·cert·영상(벤더) 잔여',NULL,9);
INSERT INTO wbs_item (id,step,grp,name,owner,start,end,progress,note,href,sort) VALUES (11,2,'Customer Admin','CA - 상품 (강의 · 디지털 · 패키지)','서만원','2026-04-27','2026-06-07',78,'[상] 전 상품유형 CRUD 완료 · 후행탭 CF 의존',NULL,10);
INSERT INTO wbs_item (id,step,grp,name,owner,start,end,progress,note,href,sort) VALUES (12,2,'Customer Admin','CA - 상품 (커뮤니티 · 멤버십)','서만원','2026-04-27','2026-06-07',55,'[상] 결제/수강생/후기/수료증 후행탭 보류',NULL,11);
INSERT INTO wbs_item (id,step,grp,name,owner,start,end,progress,note,href,sort) VALUES (13,2,'Customer Admin','CA - 판매','조수현','2026-04-27','2026-05-17',55,'[하] 쿠폰 완결 · 주문/환불 CF #18 의존',NULL,12);
...
INSERT INTO wbs_item (id,step,grp,name,owner,start,end,progress,note,href,sort) VALUES (15,2,'Customer Admin','CA - 사이트 디자인','조수현, 서만원','2026-05-04','2026-05-31',20,'[하] 메뉴 서만원(CF노출) · 나머지 조수현(빌더)',NULL,14);
INSERT INTO wbs_item (id,step,grp,name,owner,start,end,progress,note,href,sort) VALUES (16,2,'Customer Admin','CA - 운영','조수현, 서만원','2026-05-04','2026-05-17',90,'[중] 운영관리 92% · 공지·팝업 완료',NULL,15);
INSERT INTO wbs_item (id,step,grp,name,owner,start,end,progress,note,href,sort) VALUES (17,2,'Customer Admin','CA - 정산','서만원, 조수현','2026-05-04','2026-05-31',10,'[하] 매출/정산 10% · CF 거래데이터 대기',NULL,16);
INSERT INTO wbs_item (id,step,grp,name,owner,start,end,progress,note,href,sort) VALUES (18,2,'Customer Admin','CA - 설정','조수현','2026-05-04','2026-05-17',35,'[중] 공지·수료증 일부 배선',NULL,17);
INSERT INTO wbs_item (id,step,grp,name,owner,start,end,progress,note,href,sort) VALUES (19,2,'Customer Admin','CA - 통계','',NULL,NULL,0,'[하] 미착수',NULL,18);
INSERT INTO wbs_item (id,step,grp,name,owner,start,end,progress,note,href,sort) VALUES (20,3,'Customer Front','CF - 인증 + 가입','조수현','2026-04-27','2026-05-24',30,'[상] 소셜 회원가입 · 로그인',NULL,19);
INSERT INTO wbs_item (id,step,grp,name,owner,start,end,progress,note,href,sort) VALUES (21,3,'Customer Front','CF - 상품 목록/상세 (일반강의)','서만원','2026-04-27','2026-05-31',50,'[중] 일반강의 55% · 코어 카탈로그 · 상품결제 대기',NULL,20);
INSERT INTO wbs_item (id,step,grp,name,owner,start,end,progress,note,href,sort) VALUES (22,3,'Customer Front','CF - 커뮤니티','조수현, 서만원','2026-04-27','2026-05-31',5,'[중] 미착수 · 상품관리/커뮤니티·로그인 선행',NULL,21);
INSERT INTO wbs_item (id,step,grp,name,owner,start,end,progress,note,href,sort) VALUES (23,3,'Customer Front','CF - 멤버십','조수현','2026-04-27','2026-05-31',5,'[중] 미착수 · 결제PG·본인인증 선행',NULL,22);
INSERT INTO wbs_item (id,step,grp,name,owner,start,end,progress,note,href,sort) VALUES (24,3,'Customer Front','CF - 마이페이지','서만원, 조수현','2026-04-27','2026-05-31',10,'[중] nav 외 · 구매·결제 의존',NULL,23);
INSERT INTO wbs_item (id,step,grp,name,owner,start,end,progress,note,href,sort) VALUES (25,3,'Customer Front','CF - 게시판 + 기타','조수현','2026-04-27','2026-05-31',20,'[중] 공지 90% · 1:1문의 5%',NULL,24);
INSERT INTO wbs_item (id,step,grp,name,owner,start,end,progress,note,href,sort) VALUES (26,4,'Brand site','Brand - 인증 + 가입','조수현','2026-05-04','2026-05-24',5,'[상] Brand 전체 2% · 거의 미착수',NULL,25);
INSERT INTO wbs_item (id,step,grp,name,owner,start,end,progress,note,href,sort) VALUES (27,4,'Brand site','Brand - 플랜 구독','서만원','2026-05-18','2026-06-14',0,'[상] 결제 · 미착수',NULL,26);
INSERT INTO wbs_item (id,step,grp,name,owner,start,end,progress,note,href,sort) VALUES (28,4,'Brand site','Brand - 마이페이지','서만원, 조수현','2026-05-18','2026-06-14',0,'[중] 미착수',NULL,27);
...
INSERT INTO wbs_item (id,step,grp,name,owner,start,end,progress,note,href,sort) VALUES (30,5,'BackOffice','BackOffice (범위 미정)','서만원','2026-04-27','2026-06-07',66,'전체 66% · 고객·테넌트 90%·개발자 95% · 결제정산·운영도구 대기',NULL,29);
INSERT INTO wbs_item (id,step,grp,name,owner,start,end,progress,note,href,sort) VALUES (31,5,'인프라','인프라 구축','맑은소프트','2026-04-13','2026-05-31',90,'클라우드 · 도메인 · SSL · 베타 외 인프라 ~90%',NULL,30);
INSERT INTO wbs_item (id,step,grp,name,owner,start,end,progress,note,href,sort) VALUES (32,5,'인프라','CI/CD','맑은소프트','2026-04-20','2026-06-14',55,NULL,NULL,31);
