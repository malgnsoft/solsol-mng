...
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (228,6,'관리자단 구현(AD01)','AD 콘텐츠','임관개','김도형','2026-06-26','2026-07-25',0,NULL,NULL,228);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (229,6,'관리자단 구현(AD01)','AD 판매 (주문·쿠폰·환불)','임관개','김도형','2026-06-26','2026-08-08',0,NULL,NULL,229);
...
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (237,6,'브랜드 구현(BR01)','Brand 인증·플랜구독','강프개','김도형','2026-07-15','2026-09-05',0,NULL,NULL,237);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (238,6,'브랜드 구현(BR01)','Brand 마이페이지·소개·기타','강프개','김도형','2026-08-03','2026-09-19',0,NULL,NULL,238);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (239,6,'브랜드 관리자단(BO)','BackOffice 구현','임관개','김도형','2026-06-26','2026-08-22',0,NULL,NULL,239);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (700,7,'플랫폼 기획','브랜드사이트 서브페이지 기획','방준영','방준영','2026-04-21','2026-06-30',60,NULL,NULL,700);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (701,7,'플랫폼 기획','사이트 템플릿 작업 (12종)','방준영','방준영','2026-05-01','2026-07-15',30,NULL,NULL,701);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (702,7,'플랫폼 기획','SEO 설정 및 셋팅','방준영','방준영','2026-06-01','2026-07-15',20,NULL,NULL,702);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (703,7,'테스트','기획·디자인·퍼블리싱 산출물 체크','오품관','방준영','2026-07-01','2026-08-15',0,NULL,NULL,703);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (704,7,'테스트','전체 QA','오품관','방준영','2026-08-01','2026-08-31',0,NULL,NULL,704);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (705,7,'운영 및 정책','운영가이드 작업','방준영','방준영','2026-05-11','2026-07-31',30,'Google Sheets 관리',NULL,705);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (706,7,'운영 및 정책','이용약관 셋팅','방준영','방준영','2026-07-01','2026-07-31',0,NULL,NULL,706);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (707,7,'운영 및 정책','개인정보처리 방침','방준영','방준영','2026-07-01','2026-07-31',0,NULL,NULL,707);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (708,7,'운영 및 정책','마케팅동의 약관','방준영','방준영','2026-07-01','2026-07-31',0,NULL,NULL,708);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (709,7,'운영 및 정책','FAQ 작성','방준영','방준영','2026-07-15','2026-08-15',0,NULL,NULL,709);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (710,7,'마케팅','알림 마케팅 기획','방준영','방준영','2026-06-01','2026-07-15',40,NULL,NULL,710);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (711,7,'마케팅','크리에이터 섭외 (베타오픈 10명 확보 및 협의)','미정','미정','2026-07-01','2026-08-15',0,NULL,NULL,711);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (712,7,'마케팅','오픈 프로모션 기획','미정','미정','2026-08-01','2026-08-31',0,NULL,NULL,712);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (713,7,'계약','토스페이먼츠 PG 계약','미정','미정','2026-06-01','2026-07-15',10,NULL,NULL,713);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (714,7,'계약','NHN Cloud 신청','미정','미정','2026-06-01','2026-06-30',60,NULL,NULL,714);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (715,7,'계약','신한은행 펌뱅킹 계약','미정','미정','2026-07-01','2026-08-15',0,NULL,NULL,715);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (716,7,'계약','나이스평가정보 심사 및 계약','미정','미정','2026-06-01','2026-08-15',10,NULL,NULL,716);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (717,7,'WBS','D-F 관리','방준영','방준영','2026-04-26','2026-08-31',50,'Google Sheets 관리',NULL,717);
