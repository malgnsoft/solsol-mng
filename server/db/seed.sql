...
INSERT INTO wbs_item (id,step,grp,name,owner,start,end,progress,note,href,sort) VALUES (224,6,'공통·기반','API 개발','김도형','2026-06-26','2026-08-22',0,NULL,NULL,224);
...
INSERT INTO wbs_item (id,step,grp,name,owner,start,end,progress,note,href,sort) VALUES (226,6,'관리자단 구현(AD01)','AD 인증·사용자','김도형','2026-06-26','2026-07-11',0,NULL,NULL,226);
INSERT INTO wbs_item (id,step,grp,name,owner,start,end,progress,note,href,sort) VALUES (227,6,'관리자단 구현(AD01)','AD 상품 (강의·디지털·패키지·커뮤니티·멤버십)','김도형','2026-06-26','2026-08-08',0,NULL,NULL,227);
INSERT INTO wbs_item (id,step,grp,name,owner,start,end,progress,note,href,sort) VALUES (228,6,'관리자단 구현(AD01)','AD 콘텐츠','김도형','2026-06-26','2026-07-25',0,NULL,NULL,228);
INSERT INTO wbs_item (id,step,grp,name,owner,start,end,progress,note,href,sort) VALUES (229,6,'관리자단 구현(AD01)','AD 판매 (주문·쿠폰·환불)','김도형','2026-06-26','2026-08-08',0,NULL,NULL,229);
INSERT INTO wbs_item (id,step,grp,name,owner,start,end,progress,note,href,sort) VALUES (230,6,'관리자단 구현(AD01)','AD 운영·설정','김도형','2026-06-26','2026-08-01',0,NULL,NULL,230);
INSERT INTO wbs_item (id,step,grp,name,owner,start,end,progress,note,href,sort) VALUES (231,6,'관리자단 구현(AD01)','AD 마케팅·사이트디자인','김도형','2026-07-01','2026-08-29',0,NULL,NULL,231);
INSERT INTO wbs_item (id,step,grp,name,owner,start,end,progress,note,href,sort) VALUES (232,6,'관리자단 구현(AD01)','AD 정산·통계','김도형','2026-07-15','2026-09-12',0,NULL,NULL,232);
INSERT INTO wbs_item (id,step,grp,name,owner,start,end,progress,note,href,sort) VALUES (233,6,'사용자단 구현(FR01)','CF 인증·가입','김도형','2026-06-26','2026-07-25',0,NULL,NULL,233);
INSERT INTO wbs_item (id,step,grp,name,owner,start,end,progress,note,href,sort) VALUES (234,6,'사용자단 구현(FR01)','CF 강의·상품 (6유형)','김도형','2026-06-26','2026-08-15',0,NULL,NULL,234);
INSERT INTO wbs_item (id,step,grp,name,owner,start,end,progress,note,href,sort) VALUES (235,6,'사용자단 구현(FR01)','CF 결제·마이페이지','김도형','2026-07-15','2026-09-05',0,NULL,NULL,235);
INSERT INTO wbs_item (id,step,grp,name,owner,start,end,progress,note,href,sort) VALUES (236,6,'사용자단 구현(FR01)','CF 커뮤니티·멤버십·게시판','김도형','2026-07-15','2026-09-12',0,NULL,NULL,236);
INSERT INTO wbs_item (id,step,grp,name,owner,start,end,progress,note,href,sort) VALUES (237,6,'브랜드 구현(BR01)','Brand 인증·플랜구독','김도형','2026-07-15','2026-09-05',0,NULL,NULL,237);
...
INSERT INTO wbs_item (id,step,grp,name,owner,start,end,progress,note,href,sort) VALUES (239,6,'브랜드 관리자단(BO)','BackOffice 구현','김도형','2026-06-26','2026-08-22',0,NULL,NULL,239);
