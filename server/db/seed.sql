...
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (900,5,'핵심 스파이크(1차 개발)','데이터 모델·멀티테넌트 스파이크 (schema-per-tenant·Hyperdrive)','한데관','김도형','2026-06-28','2026-07-04',90,'1차 개발 검증 2라운드 통과',NULL,213);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (901,5,'핵심 스파이크(1차 개발)','인증·회원 슬라이스 (소셜 로그인·JWT·세션)','조백개','김도형','2026-06-28','2026-07-11',35,'mock E2E · 실 provider 교체 대기',NULL,214);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (902,5,'핵심 스파이크(1차 개발)','핵심 도메인 API 골격 (강의·수강·주문)','조백개','김도형','2026-07-01','2026-07-18',10,NULL,NULL,215);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (903,5,'핵심 스파이크(1차 개발)','결제·정산 연동 PoC (토스·펌뱅킹)','조백개','김도형','2026-07-05','2026-07-25',0,NULL,NULL,216);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (904,5,'핵심 스파이크(1차 개발)','강의 플레이어·진도 PoC (위캔디오 VOD)','배현우','김도형','2026-07-05','2026-07-25',0,NULL,NULL,217);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (213,6,'화면설계·정책·검증','화면목록 마스터 (272화면 채번·3중검증)','김덕조','김덕조','2026-06-24','2026-06-25',100,'00_화면목록 v1.2',NULL,223);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (214,6,'화면설계·정책·검증','화면설계서 FR/AD/BR (01~03)','김덕조','김덕조','2026-06-26','2026-07-18',90,NULL,NULL,224);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (215,6,'화면설계·정책·검증','정책설계서·정책요약 (확정 6건)','김덕조','김덕조','2026-06-26','2026-07-11',95,NULL,NULL,225);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (216,6,'화면설계·정책·검증','검증 패키지·개발–검증 절차 (dev-validation 게이트)','김덕조','김덕조','2026-06-23','2026-06-25',100,'docs/validation · DEV_VALIDATION_PROCESS',NULL,226);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (217,6,'개발 설계','DB 설계 (테이블·ERD)','한데관','김도형','2026-06-26','2026-07-04',95,NULL,NULL,227);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (218,6,'개발 설계','기능명세서 (페이지명세서)','최기획','김도형','2026-06-26','2026-07-04',0,NULL,NULL,228);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (219,6,'개발 설계','API 명세서 (1·2차)','조백개','김도형','2026-06-26','2026-08-01',25,NULL,NULL,229);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (220,6,'개발 설계','외부 연계 설계 (NHN·NICE·PG·위캔디오·펌뱅킹)','조백개','김도형','2026-07-01','2026-08-29',0,'7/1~ 2개월 실연동',NULL,230);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (221,7,'공통·기반','프레임워크·스키마·공통모듈','조백개','김도형','2026-06-26','2026-08-01',35,NULL,NULL,231);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (222,7,'공통·기반','외부 API 연동 (소셜·메시징·결제·본인인증·위캔디오)','조백개','김도형','2026-06-26','2026-08-29',5,NULL,NULL,232);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (223,7,'공통·기반','인프라·CI/CD','신배담','김도형','2026-06-26','2026-08-15',0,NULL,NULL,233);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (224,7,'공통·기반','API 개발','조백개','김도형','2026-06-26','2026-08-22',10,NULL,NULL,234);
...
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (226,7,'관리자단 구현(AD01)','AD 인증·사용자','임관개','김도형','2026-06-26','2026-07-11',0,NULL,NULL,236);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (227,7,'관리자단 구현(AD01)','AD 상품 (강의·디지털·패키지·커뮤니티·멤버십)','임관개','김도형','2026-06-26','2026-08-08',0,NULL,NULL,237);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (228,7,'관리자단 구현(AD01)','AD 콘텐츠','임관개','김도형','2026-06-26','2026-07-25',0,NULL,NULL,238);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (229,7,'관리자단 구현(AD01)','AD 판매 (주문·쿠폰·환불)','임관개','김도형','2026-06-26','2026-08-08',0,NULL,NULL,239);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (230,7,'관리자단 구현(AD01)','AD 운영·설정','임관개','김도형','2026-06-26','2026-08-01',0,NULL,NULL,240);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (231,7,'관리자단 구현(AD01)','AD 마케팅·사이트디자인','임관개','김도형','2026-07-01','2026-08-29',0,NULL,NULL,241);
...
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (233,7,'사용자단 구현(FR01)','CF 인증·가입','강프개','김도형','2026-06-26','2026-07-25',35,NULL,NULL,243);
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (234,7,'사용자단 구현(FR01)','CF 강의·상품 (6유형)','배현우','김도형','2026-06-26','2026-08-15',0,NULL,NULL,244);
...
INSERT INTO wbs_item (id,step,grp,name,owner,responsible,start,end,progress,note,href,sort) VALUES (239,7,'브랜드 관리자단(BO)','BackOffice 구현','임관개','김도형','2026-06-26','2026-08-22',0,NULL,NULL,249);
